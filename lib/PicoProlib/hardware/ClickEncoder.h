...
public:
  ...
  bool isPressRotateLocked(void) const;
  uint8_t getPressRotateMultiplier(void) const;
#endif
...
private:
  ...
  bool edge=0;
  volatile bool pressRotateLocked = false;
  volatile uint16_t pressRotateAcceleration = 0;
  bool doubleClickEnabled;
  uint16_t keyDownTicks = 0;
  uint8_t doubleClickTicks = 0;
  uint8_t buttonCheckTicks = 0;
#endif
};
